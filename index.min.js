...
},{"eventthing":8}],7:[function(require,module,exports){
"use strict";
...
},{"./engine/compositor":1,"./engine/game_loop":2,"./engine/keyboard":3,"./engine/layer":4,"./engine/layers":5,"./engine/weapon_system":6,"./sprites/level1_enemy":10,"./sprites/ship":11,"./sprites/star":12,"./weapons/simple_gun":13}],8:[function(require,module,exports){
"use strict";
...
module.exports = function (props) {
  ...
  var calculatePosition = function calculatePosition(ctx) {
    var target = ctx.ship.getPosition();
    var heading = Math.atan2(target[1] - y, target[0] - x);
...
},{"eventthing":8}],12:[function(require,module,exports){
"use strict";
