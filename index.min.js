...
},{"eventthing":9}],5:[function(require,module,exports){
"use strict";
...
},{"eventthing":9}],8:[function(require,module,exports){
"use strict";
...
var Star = require('./sprites/star'); // const et = require('eventthing')
...
},{"./engine/compositor":1,"./engine/game_loop":2,"./engine/hit_detection":3,"./engine/keyboard":4,"./engine/layer":5,"./engine/layers":6,"./engine/weapon_system":7,"./sprites/level1_enemy":11,"./sprites/ship":12,"./sprites/star":13,"./weapons/simple_gun":14}],9:[function(require,module,exports){
"use strict";
...
module.exports = function (props) {
  ...
  var calculatePosition = function calculatePosition(ctx) {
    var newHeading = calculateTrajectory([x, y], ctx.ship.getPosition(), speed / ctx.timeSinceLastFrame);
    x += newHeading[0];
    y += newHeading[1]; //const heading = Math.atan2(target[1] - y, target[0] - x)
...
},{"./bullet":10}],12:[function(require,module,exports){
"use strict";
...
},{"eventthing":9}],13:[function(require,module,exports){
"use strict";
