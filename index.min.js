...
et.on('createupgrade', function (props) {
...
},{"./engine/compositor":1,"./engine/game_loop":2,"./engine/hit_detection":3,"./engine/keyboard":4,"./engine/layer":5,"./engine/layers":6,"./engine/storyboard":8,"./levels/level1":10,"./sprites/explosion":13,"./sprites/ship":15,"./sprites/simple_gun":16,"./sprites/star":17,"./sprites/upgrade":18,"eventthing":11}],10:[function(require,module,exports){
"use strict";
...
var createBasicEnemy = function createBasicEnemy(position) {
  create('createenemy', Level1Enemy({
    position: position,
    speed: 30,
    radius: 20,
...
},{"../sprites/level1_enemy":14,"../sprites/upgrade":18,"eventthing":11}],11:[function(require,module,exports){
"use strict";
...
module.exports = function (props) {
  ...
  var instance = {
    ...
    render: function render(ctx) {
      ...
      ctx.buffer.stroke();
      ctx.buffer.fillStyle = colour; //ctx.buffer.strokeStyle = `rgb(${value}, ${value}, ${value})`
